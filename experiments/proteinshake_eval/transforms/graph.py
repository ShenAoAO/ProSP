...
class GraphPretrainTransform(object):
    def __call__(self, data):
        ...
        new_data.name = protein_dict['protein']['ID']
        return new_data
...
class GraphTrainTransform(object):
    ...
    def __call__(self, data):
        ...
        new_data.name = protein_dict['protein']['ID']
        new_data.x_coords = protein_dict['residue']['x']
        new_data.y_coords = protein_dict['residue']['y']
        new_data.z_coords = protein_dict['residue']['z']
        new_data.sequence = protein_dict['protein']['sequence']
        return new_data
